    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-12">
                ...
                <br>
                <form name="formulario" enctype="multipart/form-data" action="verificar_pdf_back.php" method="POST">
                    <label for="inputFile">Archivo</label>
                    <input name="uploadedfile" type="file" id="inputFile">
                    <p class="help-block">Suba el archivo PDF que desea verificar.</p>
    
                    <label for="inputFile">Llave Publica</label>
                    <input name="uploadedsign" type="file" id="inputFile" onclick="document.formulario.enviar.disabled=!document.formulario.enviar.disabled">
                    <p class="help-block">Suba el archivo con la Llave Publica por ejemplo: "key.pub".</p>
